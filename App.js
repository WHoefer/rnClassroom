...
import { createDirs, createDir, getFileList as localFileList, getLocalJsonFile } from './src/FileSystem';
...
render() {
  ...
  if(
    //this.state.b && this.state.c && this.state.d && this.state.e && this.state.f
    //&& this.state.g
    this.state.h
    //&&  this.state.i
  ){
    return (
      <ScrollView style={styles.container}>
        ...
        {/*renderText('FlipBookPath', `FlipBookPath from local bookshelf.json: ${JSON.stringify(this.state.updateBookshelf.flipBookPath)}`)*/}
      </ScrollView>
    );
  }
  return(
